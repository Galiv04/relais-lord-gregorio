...
const Sprites = (() => {
  ...
  const gaetano = {
    palette: { s:'#e0b090', h:'#2a2018', e:'#2a2a35', o:'#4a4a55', p:'#2a4a7a', P:'#1d3558', d:'#3a3a45', w:'#fff', g:'#c8ccd8', k:'#8a5a48', y:'#e8c840', G:'#7ae0a8', B:'#d85040' },
    map: [
      '....hhhhhhhh....',
      '...hhhhhhhhhh...',
      '..hhssssssssh...',
  ...
  // Natalino — il parrucchiere: ciuffo scolpito, orecchino, camicia bordeaux, forbicione d'argento
  const natalino = {
    palette: { s:'#e2b28e', h:'#1d1812', H:'#2e2418', e:'#2a2a35', c:'#7a2432', C:'#5a1a26', d:'#2a2a32', w:'#fff', m:'#d8dce8', M:'#9aa0b0', g:'#e8c840', k:'#8a5a48' },
    map: [
      '.....hhHHhh.....',
      '...hhHHHHHHhh...',
      '..hhHHhhhhHHh...',
  ...
  // Federico — il persuasore: barba curata, giacca su camicia azzurra, svapo e birra al limone
  const federico = {
    palette: { s:'#e0b090', h:'#33261a', b:'#4a3826', e:'#2a3a4a', c:'#5a88b0', C:'#3d6890', j:'#2c2c38', d:'#3a3a45', w:'#fff', k:'#1d1812', v:'#b8bcd0', y:'#e8c840', Y:'#f8f4d8' },
    map: [
      '....hhhhhhhh.v..',
      '...hhhhhhhhhh.v.',
      '..hhssssssss....',
  ...
  // Emanuela — la guaritrice: chignon castano, maglia verde acqua, il PHON da 2200 watt e la borsa
  const emanuela = {
    palette: { s:'#ecc2a0', h:'#8a6238', H:'#6e4c28', e:'#3a2a20', t:'#3d8a80', T:'#2a655e', d:'#2e2e3a', w:'#fff', b:'#8a5a35', k:'#a06a58', f:'#8a92b8', F:'#5a628a' },
    map: [
      '.....hhhhhh.....',
      '....hHHHHHHh....',
      '...hHssssssHh...',
