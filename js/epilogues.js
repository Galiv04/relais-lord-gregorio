...
/* Epiloghi per persona, per tipo di finale:
   ...
   'penna'   = Gregorio ha spezzato la penna: il ciclo è CHIUSO (e_penna)
   'smemorati' = la notte è stata PAGATA con la memoria (e_smemorati)           */
...
const HERO_EPILOGUES = {
  ...
  gaetano: {
    ...
    penna: `Gaetano è tornato ad agosto con il contachilometri azzerato apposta, e ha rifatto la strada: ventisei tornanti in discesa, 11,4 chilometri, dislivello coerente, benzina consumata NORMALE. Al tornante undici si è fermato, è sceso, ha guardato la valle per dieci minuti. Poi ha scritto l'ultima riga della relazione tecnica, quella che aspettava da un anno: "Anomalia risolta alla radice. Metodo: umanistico." È l'unica volta, in tutta la sua carriera, che ha firmato un documento tecnico con la stilografica. Una qualsiasi. Comprata nuova. Che scrive e basta.`,
    smemorati: `Gaetano ha trovato nel telefono una nota di quella notte, ore 4:12, scritta da lui: "NON RIPETERE L'ESPERIMENTO." Nessun contesto. Nessun ricordo. Ha passato una settimana a cercare di ricostruire l'esperimento con il rigore che metterebbe in un'indagine su un satellite perso — e niente, il buco è pulito, professionale, IRRECUPERABILE. Da allora misura tutto due volte e non sa perché. E quando in autostrada passa l'uscita di Avellino, le mani gli si stringono sul volante da sole. Claudia, dal sedile del passeggero, gli appoggia la mano sul braccio: "Tira dritto." Non sa perché lo dice. Lui non sa perché obbedisce. Tirano dritto.`,
  },
  ...
  natalino: {
    ...
    penna: `Natalino ha chiesto — e OTTENUTO — una scheggia della penna spezzata. La tiene in vetrina al salone, montata su un piedistallo minuscolo, con un cartellino scritto a mano: "Ha firmato per 125 anni. Ha smesso." Le clienti pensano sia arte moderna. Lui lascia credere. Solo a quelle speciali — quelle che arrivano con lo sguardo di chi ha dormito male in una casa che non era d'accordo — racconta la storia vera, a bassa voce, tra un colpo di forbice e l'altro. E alla fine aggiunge sempre: "Il trucco non è vincere, amore mio. Il trucco è convincere chi tiene la penna."`,
    smemorati: `Natalino ha trovato le forbici professionali giapponesi in vetrina, montate su un piedistallo, con un cartellino scritto nella SUA grafia: "In pensione. Con onore." Non ricorda di avercele messe. Non ricorda il perché. Le ha lasciate lì — "se l'ho scritto io, un motivo c'era, e mi fido di me" — e ha comprato un paio nuovo. Alle clienti racconta che la vacanza in Irpinia è stata "bellissima, piscina da sogno, torniamo l'anno prossimo". Lo dice col sorriso. Però ogni volta che in un negozio parte un carillon, abbassa la voce a metà frase. E non se ne accorge nemmeno.`,
  },
  ...
  claudia: {
    ...
    penna: `Claudia, per la prima volta in dieci anni di mestiere, ha pubblicato una foto senza pensarci: la villa nel primo sole, vuota, mortale, bellissima, con la polvere di Gregorio ancora sospesa nell'aria come un controluce. Nessuna caption. Nessun hashtag. Nessun tag. È diventato il suo post più condiviso di sempre, e lei non ha mai risposto a un solo commento. Quando il direttore marketing le ha chiesto "qual era la strategia?", ha risposto la verità: "Nessuna. È l'unica foto che ho fatto CHIEDENDO PERMESSO." Nessuno ha capito. Va benissimo così.`,
    smemorati: `A Claudia mancano ottantasette foto. Se ne è accorta subito, ovviamente — la numerazione del rullino salta, il buco è preciso come un taglio — e ha trovato nel telefono un album vuoto, creato quella notte, intitolato "NO". Non ricorda di averlo fatto. Non l'ha cancellato. Ha passato la carriera a costruire immagini, e sa riconoscere il lavoro di una professionista: quel vuoto è CURATO. Qualcuno — lei — ha deciso che ottantasette immagini non dovevano esistere, e si fida della collega. Solo una cosa è rimasta: quando inquadra una piscina di sera, il dito esita sul tasto. Un secondo. Poi scatta comunque. Quasi sempre.`,
  },
  ...
  federico: {
    ...
    penna: `Federico ha comprato la villa. OVVIAMENTE Federico ha comprato la villa — "era un affare, ragazzi, un AFFARE VERO stavolta" — ed è l'unico immobile della sua vita che ha pagato senza trattare di un euro. L'ha intestata a una cooperativa di Pietrafonda: il bar di Peppe fa il catering, Don Michele benedice le stagioni "male e a festa", e il regolamento interno, scritto da Federico personalmente, ha un solo articolo in grassetto: "Il registro degli ospiti si firma ALL'USCITA. Se vi è piaciuto."`,
    smemorati: `Federico ha trovato nel cassetto la stampa di una prenotazione — "Relais Belvedere, 5 ospiti, weekend" — con una nota a margine nella sua grafia: "MAI PIÙ ANTICIPI." Non ricorda il weekend. Non ricorda la nota. Il conto in banca conferma l'anticipo, e questo lo tormenta più di tutto: Federico DIMENTICA i weekend, può succedere, ma Federico non dimentica un ANTICIPO. Da allora legge ogni contratto due volte, anche i moduli della palestra. E ai clienti che hanno fretta di firmare dice sempre la stessa frase, che non sa da dove gli venga e che gli esce con una convinzione che lo spaventa: "Domattina. Con calma."`,
  },
  ...
  emanuela: {
    ...
    penna: `Emanuela ha trapiantato l'orto di Ada a Pietrafonda, aiuola per aiuola, nel terreno dietro la canonica — "le erbe non si abbandonano, non discutere". Le erbe argentate hanno attecchito al primo colpo, cosa che il vivaista della valle definisce "botanicamente offensiva". Ora ogni giovedì, giorno di mercato, c'è un banchetto piccolo con tisane e mazzetti legati a spago, e un cartello scritto col pennarello: "Contro il freddo. Quale freddo? Nessuno. FINALMENTE." I soldi vanno alla cooperativa della villa. Il primo mazzetto di ogni raccolto, però, lo porta lei al pozzo. Per una che ha ancora le mani fredde.`,
    smemorati: `Emanuela ha trovato nella borsa un mazzetto di erbe argentate legate a spago. Non ricorda di averle raccolte, non riconosce la specie, e il vivaista di fiducia nemmeno. Le ha tenute. Quando seccano troppo, le rinnova con altre erbe simili, "per abitudine" — un'abitudine che non ricorda di aver preso. E una sera d'agosto, ogni anno, sempre la stessa, prepara la tisana senza contare le tazze: ne vengono fuori cinque. A tavola sono in cinque. I conti tornano, dice lei. E se mentre versa le viene da mormorare "contro il freddo"... be', è agosto, fa caldo, e nessuno le chiede mai QUALE freddo.`,
  },
...
const IMPRESE = [
  ...
  { flag: 'strada_che_torna',    icon: '🛣', title: 'Il Tornante Undici',           desc: 'Avete visto la strada tornare — e siete rientrati con la risposta in tasca.' },
  { flag: 'giardiniere_potato',  icon: '🌾', title: 'Potatura Straordinaria',       desc: 'Il Giardiniere è paglia sparsa nei filari. Il turno di notte è scoperto.' },
  { flag: 'biglietto_strappato', icon: '🎫', title: 'Ritenta',                      desc: 'L\'ultimo Gratta e Vinci aveva vinto "per sempre". Strappato in due, in faccia al banco.' },
  { flag: 'casa_rispetta',       icon: '⚖', title: 'Vizio del Consenso',           desc: 'Avete denunciato la trappola al maggiordomo. Il sorriso è scivolato di un millimetro.' },
  { flag: 'cucina_in_sciopero',  icon: '🍳', title: 'La Cucina Sciopera',           desc: 'Lo Chef dalla vostra parte del tavolo, i camerieri rientrati nelle pareti.' },
...
const CRONACA = [
  ...
  { flag: 'giardiniere_potato', text: 'Lo spaventapasseri si è rifatto, com\'era inevitabile. Ma adesso sta nei filari a fare il suo mestiere: spaventa i corvi. Ai passanti notturni, dicono, si toglie il cappello.' },
