...
const HEROES = [
  {
    ...
    abilities: [
      ...
      { id: 'powerbank', name: 'Analisi Strutturale', uses: 2, type: 'mark',
        desc: 'Indica il punto debole: per 2 round TUTTI gli attacchi contro quel nemico hanno VANTAGGIO.' },
    ],
  ...
  },
  {
    ...
    abilities: [
      ...
      { id: 'meeting', name: 'Scudo Umano', uses: 2, type: 'guard',
        desc: 'Si piazza davanti a un amico: il prossimo attacco nemico viene intercettato da Federico.' },
    ],
